...
class Fetcher:
    ...
    def parsed(self, items):
        ...
        for comment in items:
            comment_author = Author(name=comment['snippet']['topLevelComment']['snippet']['authorDisplayName'],
                                    link=comment['snippet']['topLevelComment']['snippet']['authorChannelUrl'],
                                    pic_link=comment['snippet']['topLevelComment']['snippet']['authorProfileImageUrl'])
            comment_complete = Comment(comment_author,
